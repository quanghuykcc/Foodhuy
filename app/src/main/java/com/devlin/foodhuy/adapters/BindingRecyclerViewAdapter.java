...
public class BindingRecyclerViewAdapter<T, V extends BaseViewModel> extends RecyclerView.Adapter<BindingRecyclerViewAdapter.ViewHolder> implements View.OnClickListener, View.OnLongClickListener
{
    ...
    private static class WeakReferenceOnListChangedCallback<T, V extends BaseViewModel> extends ObservableList.OnListChangedCallback
    {

        private final WeakReference<BindingRecyclerViewAdapter<T, V>> adapterReference;
