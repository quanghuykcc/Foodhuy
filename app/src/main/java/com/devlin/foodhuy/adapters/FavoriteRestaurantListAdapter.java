 ...
 */
public class FavoriteRestaurantListAdapter extends BaseRecyclerViewAdapter<FavoriteRestaurantViewModel, List<Restaurant>> {

    //region Override Methods

    @Override
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ViewDataBinding viewDataBinding = DataBindingUtil.inflate(LayoutInflater.from(parent.getContext()), R.layout.item_favorite_restaurant, parent, false);
